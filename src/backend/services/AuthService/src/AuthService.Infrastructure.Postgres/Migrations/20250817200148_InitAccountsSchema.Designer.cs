...
namespace AuthService.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20250817200148_InitAccountsSchema")]
    partial class InitAccountsSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthService.Domain.AdminAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "AuthService.Domain.AdminAccount.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("AuthService.Domain.RefreshSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ExpiresIn")
                        .HasDatabaseName("ix_refresh_sessions_expires_in");

                    b.HasIndex("Jti")
                        .IsUnique()
                        .HasDatabaseName("ix_refresh_sessions_jti");
                    ...
                    b.HasIndex("UserId", "ExpiresIn")
                        .HasDatabaseName("ix_refresh_sessions_active");

                    b.ToTable("refresh_sessions", "accounts", t =>
                        {
                            t.HasCheckConstraint("ck_refresh_sessions_expires_after_created", "\"expires_in\" > \"created_at\"");
                        });
                });
            ...
            modelBuilder.Entity("AuthService.Domain.AdminAccount", b =>
                {
                    b.HasOne("AuthService.Domain.User", "User")
                        .WithOne()
                        .HasForeignKey("AuthService.Domain.AdminAccount", "UserId")
