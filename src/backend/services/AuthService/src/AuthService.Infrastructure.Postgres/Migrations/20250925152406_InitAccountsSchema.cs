...
{
    /// <inheritdoc />
    public partial class InitAccountsSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    expires_in = table.Column<DateTime>(type: "timestamptz", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamptz", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_refresh_sessions", x => x.id);
                    table.CheckConstraint("ck_refresh_sessions_expires_after_created", "\"expires_in\" > \"created_at\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_refresh_sessions_active",
                schema: "accounts",
                table: "refresh_sessions",
                columns: new[] { "user_id", "expires_in" });

            migrationBuilder.CreateIndex(
                name: "ix_refresh_sessions_expires_in",
                schema: "accounts",
                table: "refresh_sessions",
                column: "expires_in");

            migrationBuilder.CreateIndex(
                name: "ix_refresh_sessions_jti",
                schema: "accounts",
                table: "refresh_sessions",
                column: "jti",
                unique: true);
