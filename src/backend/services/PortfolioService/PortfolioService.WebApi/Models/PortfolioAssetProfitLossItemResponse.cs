...
{
    /// <summary>
    /// Модель контроллера для расчета доходности актива в портфеле
    /// </summary>
    public record PortfolioAssetProfitLossItemResponse
    {
        /// <summary>
        ...
        /// </summary>
        public decimal WeightInPortfolio { get; init; }
    }
}
