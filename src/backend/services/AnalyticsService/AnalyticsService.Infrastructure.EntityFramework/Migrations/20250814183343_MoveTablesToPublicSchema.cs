...
{
    /// <inheritdoc />
    public partial class MoveTablesToPublicSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    total_buy_quantity = table.Column<int>(type: "integer", nullable: false),
                    total_sell_quantity = table.Column<int>(type: "integer", nullable: false),
            ...
            // Создаем индексы для транзакций в схеме public
            ...
            // Создаем индексы для рейтингов в схеме public
            migrationBuilder.CreateIndex(
            ...
            // Копируем данные из схемы analytics в схему public (если таблицы существуют)
            ...
            // Удаляем таблицы из схемы analytics
        ...
        {
            // Восстанавливаем схему analytics
            migrationBuilder.EnsureSchema(
                name: "analytics");

            // Восстанавливаем таблицы в схеме analytics
            migrationBuilder.CreateTable(
                name: "asset_transactions",
                schema: "analytics",
                columns: table => new
            ...
            // Восстанавливаем индексы в схеме analytics
            migrationBuilder.CreateIndex(
                name: "ix_asset_transactions_portfolio_id_transaction_time",
                schema: "analytics",
                table: "asset_transactions",
            ...
            // Копируем данные обратно из схемы public в схему analytics
            migrationBuilder.Sql(@"
                INSERT INTO analytics.asset_transactions 
                SELECT * FROM public.asset_transactions;
            ");

            migrationBuilder.Sql(@"
                INSERT INTO analytics.asset_ratings 
                SELECT * FROM public.asset_ratings;
            ");

            // Удаляем таблицы из схемы public
            migrationBuilder.DropTable(
                name: "asset_transactions",
                schema: "public");
